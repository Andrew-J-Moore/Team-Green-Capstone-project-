...
export class DataStorageService {
  private baseUrlEvent = "http://0.0.0.0:8080/api/event/";
  private baseUrlCalendar = "http://0.0.0.0:8080/api/calendar/";
  private baseUrlAdmin = "http://0.0.0.0:8080/api/admin/"
  ...
  getEmails() {
    ...
    this.http
      .get<ApiResponse>("http://0.0.0.0:8080/api/admin/getAllUsers")
      .pipe(
        (map(data => data),
  ...
  resetPassword(email: string) {
    ...
    return this.http
      .post<ApiResponse>("http://0.0.0.0:8080/api/auth/forgot", formdata)
      .pipe(
  ...
  submitPassword(obj: Object) {
    ...
    return this.http
      .post<ApiResponse>(
        "http://0.0.0.0:8080/api/auth/processResetPassword",
        obj
      )
      .pipe(
        (map(data => data), catchError(error => throwError(error))),
  ...
  updatePassword(obj: Object) {
    ...
    return this.http
      .put<ApiResponse>("http://0.0.0.0:8080/api/admin/changePassword", obj)
      .pipe(
        (map(data => data), catchError(error => throwError(error))),
        finalize(() => this.isLoadingSubject.next(false))
      );
  ...
  registerUsers(file: File, role: string) {
    ...
    return this.http
      .post<ApiResponse>(
        "http://0.0.0.0:8080/api/file/uploadUser/"+role,
        formdata
      )
      .pipe(
        (map(data => data), catchError(error => throwError(error))),
  ...
  fetchUpcomingEvents() {
    this.isLoadingSubject.next(true);
    this.http
      .get<ApiResponse>("http://0.0.0.0:8080/api/event/" + "upCommingEvents")
      .pipe(
        (map(data => data),
        catchError(error => throwError(error)),
        finalize(() => this.isLoadingSubject.next(false)))
  ...
  getMajors() {
    this.isLoadingSubject.next(true);
    this.http.get<ApiResponse>('http://0.0.0.0:8080/api/group/getAllMajors').pipe(
      (map(data=>data), catchError(error => throwError(error))),
      finalize(()=>this.isLoadingSubject.next(false))
    ).subscribe(result => {
  ...
  uploadMajors(formdata: FormData) {
    return this.http
      .post<ApiResponse>(
        "http://0.0.0.0:8080/api/admin/uploadCourses",
        formdata
      )
      .pipe(
        (map(data => data), catchError(error => throwError(error))),
  ...
  emailSelectedMembers(obj: Object) {
    ...
    return this.http
      .post<ApiResponse>(
        "http://0.0.0.0:8080/api/group/" + "sendEmailToFew",
        obj
      )
      .pipe(
        (map(data => data), catchError(error => throwError(error))),
